...
"""
    This code file is the work of someone else, but we have forgotten its source. 
    If it infringes upon your rights, please let us know.
"""
...
def PSNR(H_fuse, H_ref):
    ...
    PSNR = 20*torch.log10(max_H_ref / rmse / N_spectral) 
